...
public class Cirugia extends Paciente implements reporte, apoyo{
    ...
    public Cirugia( String cod, String apeynom, String sexo, String especialidad, int edad, int diasint, double costodia, double costocir){
        super(cod, apeynom, sexo, especialidad, edad, diasint, costodia);
        this.costocir = costocir;
    }

    public double getCostocir() {
        return costocir;
    }

    public void setCostocir(double costocir) {
        this.costocir = costocir;
    }
    ...
    public String toString(){
        ...
        return super.toString()+ " importe total a pagar es: "+ importeBrutoPagar();
    }
    
    public double descuento(){
        
        return importeBrutoPagar()*0.1;
    }
    
   
    
    
    public double importeBrutoPagar(){
        
        return getDiasint()*getCostodia()+getCostocir()-getDiasint()*getCostodia()*0.1;
    }
