 ...
 */
public class Gastroenterologia extends Paciente{

    public Gastroenterologia(String cod,String apeynom,String sexo,String especialidad, int edad,int diasint,double costodia,double costogas) {
    ...
    public double importeBrutoPagar(){
        ...
        return getDiasint()*getCostodia()+getCostogas()-getDiasint()*getCostodia()*0.1;
    }
