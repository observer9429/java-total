 ...
 */
public class Neurologia extends Paciente{

    public Neurologia( String cod, String apeynom, String sexo, String especialidad, int edad, int diasint, double costodia, double costoneu) {
        super(cod, apeynom, sexo, especialidad, edad, diasint, costodia);
        this.costoneu = costoneu;
    }

    public double getCostoneu() {
        return costoneu;
    }

    public void setCostoneu(double costoneu) {
        this.costoneu = costoneu;
    }
    ...
    public double importeBrutoPagar(){
        ...
        return getDiasint()*getCostodia()+getCostoneu()-getDiasint()*getCostodia()*0.1;
    }
    
    
    
    private double costoneu;
}
