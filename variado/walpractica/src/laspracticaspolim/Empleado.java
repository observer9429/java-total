...
public class Empleado {
	...
	public Empleado(String cod, String apeynom, String sexo, String estado, String cat, double sueldob,
			double bonogen) {
	...
	public void calculaSueldo() {
		...
		stotal=getSueldob()+getBonogen();
	}
	

	public void calculaSueldo(double bonotecesp, double bonotecvida) {
		
		stotal=getSueldob()+getBonogen()+bonotecesp+bonotecvida;
		
	}
	
	
	public void calculaSueldo(double descuento) {
		
		stotal=getSueldob()+getBonogen()-descuento;
	}
